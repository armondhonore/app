# Nexlayer — simplelogin

**Live:** [https://relaxed-weasel-simplelogin.cloud.nexlayer.ai](https://relaxed-weasel-simplelogin.cloud.nexlayer.ai)  
...
**simplelogin** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/simplelogin/app:latest
    path: /
    servicePorts:
    - 7777
    vars:
      URL: "https://relaxed-weasel-simplelogin.cloud.nexlayer.ai"
      DB_URI: "postgresql://simplelogin:${POSTGRES_PASSWORD}@postgres.pod:5432/simplelogin"
      FLASK_SECRET: "a1b2c3d4e5f6a1b2c3d4"
